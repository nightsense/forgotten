...
<ul>
  <li>disable highlighting of current line number: <code class="highlighter-rouge">let g:forgotten_dark_CursorLineNr = 'off'</code>, <code class="highlighter-rouge">let g:forgotten_light_CursorLineNr = 'off'</code></li>
</ul>
